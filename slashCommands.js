...
export const handleSlashCommands = async (interaction) => {
    ...
    switch (interaction.commandName) {
        ...
        case "draw_picture":
            ...
            interaction.reply({
                content: `I have begun crafting a piece of art depicting: ${description}. 
                I will put it in the gallery when it is complete. photorealistic? ${style ? "yes" : no}
                . Will I account for words in the image? ${blackForestLabs ? "yes" : "no"}`,
                ephemeral: true
            });
            try {
                let response;
